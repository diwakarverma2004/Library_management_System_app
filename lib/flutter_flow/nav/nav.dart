...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const DashboardWidget() : const Auth2LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'IssueBooks',
          path: '/issueBooks',
          builder: (context, params) => const IssueBooksWidget(),
        ),
        FFRoute(
          name: 'RequestedBooks',
          path: '/requestedBooks',
          builder: (context, params) => RequestedBooksWidget(
        ...
        FFRoute(
          name: 'bookdetail',
          path: '/bookdetail',
          builder: (context, params) => const BookdetailWidget(),
        ),
        FFRoute(
          name: 'auth_2_Create',
          path: '/auth2Create',
        ...
        FFRoute(
          name: 'phone_signup',
          path: '/phoneSignup',
          builder: (context, params) => const PhoneSignupWidget(),
        ),
        FFRoute(
          name: 'otp',
          path: '/otp',
        ...
        FFRoute(
          name: 'issued_books',
          path: '/issued_books',
          builder: (context, params) => IssuedBooksWidget(
            bookname: params.getParam(
              'bookname',
              ParamType.String,
            ),
